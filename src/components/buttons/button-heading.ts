...
export class PdButtonHeading extends PdButton {
    ...
    isActive() {
        return this.editor.tiptap.isActive('heading');
    }
        ...
        return [
            {
                ...
                action: () => {
                    this.editor.tiptap.chain().focus().toggleHeading({ level: 2 }).run()
                }
            },
            {
                title: 'H3',
                ...
                action: () => {
                    this.editor.tiptap.chain().focus().toggleHeading({ level: 3 }).run()
                }
            },
            {
                title: 'H4',
                ...
                action: () => {
                    this.editor.tiptap.chain().focus().toggleHeading({ level: 4 }).run()
                }
            },
            {
                title: 'H5',
                ...
                action: () => {
                    this.editor.tiptap.chain().focus().toggleHeading({ level: 5 }).run()
                }
            },
            {
                title: 'H6',
                ...
                action: () => {
                    this.editor.tiptap.chain().focus().toggleHeading({ level: 6 }).run()
                }
            }
        ]
    }
